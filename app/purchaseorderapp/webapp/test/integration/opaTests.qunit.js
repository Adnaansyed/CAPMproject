...
sap.ui.require(
  [
    ...
    "purchaseorderapp/test/integration/PurchaseOrderSrvListJourney",
    "purchaseorderapp/test/integration/PurchaseOrderSrvObjectPageJourney",
    "purchaseorderapp/test/integration/PurhcaseItemSrvObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
